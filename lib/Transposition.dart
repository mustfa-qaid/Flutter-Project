...
class TranspositionPage extends StatelessWidget {
  Algorithems cipher = Algorithems();
  TextEditingController n1 = TextEditingController();
  TextEditingController n2 = TextEditingController();
  TextEditingController n3 = TextEditingController();

  TranspositionPage({super.key});
                ...
                Row(
                  ...
                  children: [
                    FilledButton(
                        ...
                        onPressed: () {
                          n3.text = cipher.transpositionEncrypt(
                              n1.text, int.parse(n2.text));
                        },
                        child: Text("Encrypt",style: TextStyle(fontSize: 18,color: Colors.black54),)),
                    FilledButton(
                        style: FilledButton.styleFrom(backgroundColor: Colors.greenAccent),
                        onPressed: () {
                          n3.text = cipher.transpositionDecrypt(
                              n1.text, int.parse(n2.text));
                        },
